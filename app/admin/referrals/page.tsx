...
export default function ReferralsPage() {
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto" }}>
      ...
      {/* Header */}
      <div style={{ background: "linear-gradient(135deg, #92400e, #d97706, #f59e0b)", borderRadius: 0, padding: "2rem 2.5rem", marginBottom: "1.5rem", position: "relative", overflow: "hidden", boxShadow: "0 20px 60px rgba(217,119,6,0.3)" }}>
